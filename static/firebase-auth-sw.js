...
importScripts('https://www.gstatic.com/firebasejs/9.8.4/firebase-auth-compat.js')
firebase.initializeApp({
    apiKey: 'AIzaSyBAc5klyLS7RSkHRLv0japdzm-zhMMzj9I',
    authDomain: 'deskvantage-fb75f.firebaseapp.com',
    databaseURL: 'https://deskvantage-fb75f-default-rtdb.firebaseio.com',
    projectId: 'deskvantage-fb75f',
    storageBucket: 'deskvantage-fb75f.appspot.com',
    messagingSenderId: '445099563469',
    appId: '1:445099563469:web:55bb9ac1f0098da9ed8c84',
    measurementId: 'G-H3W4TTQZNE',
})
...
self.addEventListener('fetch', (event) => {
    ...
    // This can also be integrated with existing logic to serve cached datamanagement
    // in offline mode.
    event.respondWith(
